      ...
      <div className=" h-full w-[80%] mx-auto  400px:p-10 ">
        <div className="h-full flex flex-col  800px:flex-row 800px:justify-between">
          <div className="mt-5 800px:mt-20">
            <h2 className="text-blue-600 font-semibold text-[40px] 800px:text-[10vh]">
              facebook
            </h2>
            <h3>
              Facebook helps ou connect and share <br />
          ...
          <div className="h-[51vh] w-[98%] 800px:w-[50%] bg-white rounded-sm mt-16">
            <div className="h-full w-full p-1 800px:p-3">
              <form onSubmit={HandelLogin}>
                ...
                <div className="mt-2">
                  <p
                    className="text-blue-600 text-[12px] text-center border-b-[1px] 
                                  border-[#dbcece] pb-3"
                  >
      ...
      {open && (
        <div className="h-[100vh] w-[100%] bg-[#00000060]  absolute top-0  ">
          <div className="min-h-[70vh] w-[95%] 800px:w-[40%] bg-white mx-auto mt-20 rounded-sm ">
            <div className="flex justify-between p-2 800px:p-3 cursor-pointer  w-full h-[12vh]">
            ...
            <div className="border-[#dfd3d3] border-b "/>

            <div className="p-2 800px:p-4">
              <form onSubmit={HandelReg} className="mt-2">
                <div>
                ...
                <div className="p-2 mt-1">
                  ...
                  <p className="text-[9px] mt-1">
                    People who use our service By clicking Sign Up, you agree to
                    our Terms, Privacy Policy and Cookies Policy. You may
                    receive SMS notifications from us and can opt out at any
                    time..
                  </p>
                </div>
