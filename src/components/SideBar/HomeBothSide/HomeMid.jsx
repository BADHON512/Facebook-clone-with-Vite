             ...
             <div className="w-full min-h-[70vh] bg-[#242526] rounded-sm">
                ...
                <div className="w-full min-h-[70vh] bg-[#242526] rounded-sm">
                    <div className="p-3">
                        ...
                        <div className="h-[70vh] w-full">
                            <div className="h-full">
                            <iframe src="https://www.facebook.com/plugins/post.php?href=https%3A%2F%2Fwww.facebook.com%2Fmd.badhon.984991%2Fposts%2Fpfbid02n8zK3KjUFcWfASm63inpPvckHS1V1Nc11tfj65e3s73wQMPoyk42Gjp6gASBt5z9l&show_text=false&width=500" className="h-[70vh] w-full" ></iframe>
                            </div>
                        </div>
                ...
                <div className="w-full min-h-[70vh] bg-[#242526] rounded-sm">
                    <div className="p-3">
                        ...
                        <div className="p-1">
                            <h1 className="text-[18px]"> My elder brother's wedding day.</h1>
                        </div>

                        <div className="h-[50vh] w-full">
                            <div className="h-full">
                            <img src="https://scontent.fdac24-1.fna.fbcdn.net/v/t39.30808-6/332522504_2155806807941324_3349957016648515491_n.jpg?stp=dst-jpg_p180x540&_nc_cat=102&ccb=1-7&_nc_sid=49d041&_nc_ohc=RELWWPBNfAIAX_YeEAP&_nc_ht=scontent.fdac24-1.fna&oh=00_AfDUeHxB4TGGXmDxPjqqJ0xSq911rWiy__Cg36z6r_NRuw&oe=6510E856" className="h-[50vh] w-full" alt="" />
                            </div>
                        </div>
                ...
                <div className="w-full min-h-[70vh] bg-[#242526] rounded-sm">
                    <div className="p-3">
                        ...
                        <div className="h-[50vh] w-full">
                            ...
                            <img src="https://scontent.fdac24-1.fna.fbcdn.net/v/t1.6435-9/131272799_1255528598160737_6579726483531741585_n.jpg?_nc_cat=110&ccb=1-7&_nc_sid=174925&_nc_ohc=7Ei23w45QEsAX9wfJ5c&_nc_ht=scontent.fdac24-1.fna&oh=00_AfCu-O0ABOE-oJ1hg4XT49Z5QzQcfMi-MTPlqGAT4D5L9g&oe=6533D37F" className="h-[50vh] " alt="" />
                            </div>
                        </div>
