        ...
        <div className='w-full 800px:h-screen text-white shadow-lg bg-[#242526]'>
           ...
           <div className='flex justify-between  items-center'>
             ...
             <div className='mt-4 relative w-full'>
                <input type="text"  className='w-[200px] mr-2 800px:w-[90%] bg-[#9695953d] pl-11 py-2 rounded-3xl placeholder:text-white placeholder:ml-5 outline-none ' placeholder='Search videos'  />
                <AiOutlineSearch className='absolute top-2 left-4' size={25}   />
             </div>


             <div className={`w-full p-2 mt-3 cursor-pointer hover:bg-[#d3d1d144] ${color===1?'bg-[#d3d1d144]':null} rounded-md`} onClick={()=>setColor(1)}>
           ...
           <div className={`w-full p-2 mt-3 cursor-pointer hover:bg-[#d3d1d144] ${color===2?'bg-[#d3d1d144]':null} rounded-md`} onClick={()=>setColor(2)}>
            <div className='flex gap-x-3 items-center'>
           ...
           <div className={`w-full p-2 mt-3 cursor-pointer hover:bg-[#d3d1d144] ${color===3?'bg-[#d3d1d144]':null} rounded-md`} onClick={()=>setColor(3)}>
            <div className='flex gap-x-3 items-center'>
           ...
           <div className={`w-full p-2 mt-3 cursor-pointer hover:bg-[#d3d1d144] ${color===4?'bg-[#d3d1d144]':null} rounded-md`} onClick={()=>setColor(4)}>
            <div className='flex gap-x-3 items-center'>
           ...
           <div className={`w-full  p-2 mt-3 cursor-pointer hover:bg-[#d3d1d144] ${color===5?'bg-[#d3d1d144]':null} rounded-md`} onClick={()=>setColor(5)}>
            <div className='flex gap-x-3 items-center'>
