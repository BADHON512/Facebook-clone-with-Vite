...
const MarketLeft = () => {
    ...
    return (
        <div className='w-full h-screen text-white shadow-lg bg-[#242526]'>
           <div className='p-3'>
             <div className='flex justify-between  items-center'>
                <h1 className='text-[25px] text-[#d8d5d5] 
                font-semibold'>MarketPlace</h1>
             ...
             <div className={`p-2 mt-3 cursor-pointer hover:bg-[#d3d1d144] ${color===1?'bg-[#d3d1d144]':null} rounded-md`} onClick={()=>setColor(1)}>
           ...
           <div className={`p-2 mt-3 cursor-pointer hover:bg-[#d3d1d144] ${color===2?'bg-[#d3d1d144]':null} rounded-md`} onClick={()=>setColor(2)}>
            <div className='flex gap-x-3 items-center'>
           ...
           <div className={`p-2 mt-3 cursor-pointer hover:bg-[#d3d1d144] ${color===3?'bg-[#d3d1d144]':null} rounded-md`} onClick={()=>setColor(3)}>
            <div className='flex gap-x-3 items-center'>
           ...
           <div className={`p-2 mt-3 cursor-pointer hover:bg-[#d3d1d144] ${color===4?'bg-[#d3d1d144]':null} rounded-md`} onClick={()=>setColor(4)}>
            <div className='flex gap-x-3 items-center'>
           ...
           <div className={`p-2 mt-3 cursor-pointer hover:bg-[#d3d1d144] ${color===5?'bg-[#d3d1d144]':null} rounded-md`} onClick={()=>setColor(5)}>
            <div className='flex gap-x-3 items-center'>
           ...
           <button className='py-2'> + Create New listing </button>

           <div className={`p-2 mt-3 cursor-pointer hover:bg-[#d3d1d144] ${color===6?'bg-[#d3d1d144]':null} rounded-md`} onClick={()=>setColor(6)}>
            <div className='flex gap-x-3 items-center'>
