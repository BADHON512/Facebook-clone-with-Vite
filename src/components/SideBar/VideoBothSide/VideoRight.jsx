...
const VideoRight = () => {
  ...
  const title =
    "অতিরিক্ত তৈল মারলে এমনই হয় 😂😂 অসামাজিক রাজনৈতিক ভিডিও পার্ট ৩";
  const title2 =
    'যদি আপনি "এই মহাবিশ্ব" সম্পর্কে আরও তথ্য দেতে চান বা এটি সম্পর্কে কোনও প্রশ্ন থাকে, তবে আমিকে আরও তথ্য দিতে বলুন এবং আমি আপনার সাহায্য করতে গোপনীয়ভাবে প্রয়াস করব';
        ...
        <div className="p-1 mt-3  items-center ">
          <div className="flex justify-center 500px:justify-between">
            ...
            <div className="hidden 500px:flex gap-x-3 items-center 400px:flex-col 800px:flex-col 1000px:flex-row ">
              <div className="flex">
                <h1 className="text-sm text-[#d3d3d3] flex">
