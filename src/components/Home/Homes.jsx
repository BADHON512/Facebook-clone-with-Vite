    ...
    <div className=" bg-[#18191A]">
      <ReelsContext.Provider value={{ reels, setReels }}>
        ...
        <div
          className={`${
            reels ? "hidden" : null
          } w-full min-h-screen flex flex-col 800px:flex-row 800px:justify-between`}
        >
          ...
          <div
            className={`${
              iconBorder === 2 || iconBorder === 3 || iconBorder === 5
                ? " w-full 800px:w-[75vw]"
                : null
            } ${
              iconBorder === 1 || iconBorder === 4
                ? "w-full 800px:w-[50vw]"
                : null
            } w-[50vw]`}
          >
            ...
            <div className="flex justify-between ">
              <div className="hidden 800px:block">
                <div className="flex gap-x-2 items-center h-[5vh] 800px:w-[35vw]">
                  <RxCross1
                    onClick={() => setReels(false)}
                    size={30}
                    className="cursor-pointer"
                  />
                  <img
                    src="/img/facebook-logo.png"
                    className="h-[40px] w-[50px] hidden 800px:block "
                    alt="img"
                  />
                  <h1 className="text-[30px] hidden 800px:block text-[#f3f0f0e7] font-semibold">
                    Reels
                  </h1>
                </div>
              </div>
                ...
                >
                  {videoRef.map((v) => (
                    <>
                      <SwiperSlide key={v}>
                        {" "}
                        <div className="h-[95vh] w-full rounded-md ">
                          <SingleVideoPlayer videoUrl={v} />
                        </div>
                      </SwiperSlide>
                    </>
                  ))}
              ...
              <div className=" w-[15vw] 800px:w-[35vw] h-screen hidden 800px:block">
                <div className="flex flex-col items-end w-full">
                  ...
                  <div className="h-[40px] w-[130px] bg-[gray] flex rounded-3xl mt-3 items-center  justify-center">
                    <h1 className="flex font-semibold  gap-x-1">
                      <PiFilmReelDuotone size={25} /> Create Reel
                    </h1>
                  </div>
                </div>
                    ...
                    <div className="flex justify-between w-full items-end p-5">
                      <div className="space-y-3">
                        <div>
                          ...
                          <h1 className="text-[#f7f7f7c4]   font-semibold text-center">
                            Give!
                          </h1>
                        </div>
                        ...
                        <div>
                          ...
                          <h1 className="text-[#f7f7f7c4]  text-center font-semibold">
                            41.1k
                          </h1>
                        </div>
