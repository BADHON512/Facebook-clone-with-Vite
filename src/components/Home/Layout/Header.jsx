          ...
          <div className="h-full w-full flex items-center justify-between">
            ...
            <div>
              <div className=" hidden 800px:flex 800px:items-center 800px:gap-x-20 ">
                <div
                  className="h-[8vh] flex items-center justify-center  w-[30%] relative cursor-pointer"
                  onClick={() => setIconBorder(1)}
                >
                  <AiOutlineHome
                    color={`${iconBorder === 1 ? "#2374E1" : "#B8BBBF"}`}
                    size={30}
                  />
                  <div
                    className={`${
                      iconBorder === 1
                        ? "h-1 w-20 bg-[#2374E1] absolute bottom-0  rounded-lg"
                        : null
                    }`}
                  ></div>
                </div>
                ...
                >
                  <MdOutlineOndemandVideo
                    color={`${iconBorder === 2 ? "#2374E1" : "#B8BBBF"}`}
                    size={30}
                  />
                  <div
                    className={`${
                ...
                >
                  <SiHomeassistantcommunitystore
                    color={`${iconBorder === 3 ? "#2374E1" : "#B8BBBF"}`}
                    size={30}
                  />
                  <div
                    className={`${
                ...
                >
                  <HiUserGroup
                    color={`${iconBorder === 4 ? "#2374E1" : "#B8BBBF"}`}
                    size={30}
                  />
                  <div
                    className={`${
                ...
                >
                  <FaGamepad
                    color={`${iconBorder === 5 ? "#2374E1" : "#B8BBBF"}`}
                    size={30}
                  />
                  <div
                    className={`${
              ...
              <div className={`800px:hidden`}>
                <AiOutlineMenu
                  color={`${iconBorder === 6 ? "#2374E1" : "#B8BBBF"}`}
                  size={30}
                  className="cursor-pointer "
                  onClick={() => {
                    setOpen(!open);
            ...
            <div>
              <div className="flex items-center gap-x-3">
                <div
                  className="h-[40px] w-[40px] rounded-full bg-[#4E4F4F] flex items-center justify-center cursor-pointer"
                  onClick={() => toggleTab(1)}
                >
                  <CgMenuGridR
                    color={`${grid === 1 ? "blue" : "#C5C6CA"}`}
                    size={27}
                  />
                </div>

                <div
                  className="h-[40px] w-[40px] rounded-full bg-[#4E4F4F] flex items-center justify-center cursor-pointer relative"
                  onClick={() => toggleTab(2)}
                >
                  <RiMessengerFill
                    color={`${grid === 2 ? "blue" : "#C5C6CA"}`}
                    size={27}
                  />
                  <h1 className="absolute h-5 w-5 rounded-full bg-[red] font-semibold flex items-center justify-center -top-1 -right-1">
                    3
                  </h1>
                </div>
                <div
                ...
                <div
                  className="h-[40px] w-[40px] rounded-full flex items-center justify-center cursor-pointer"
                  onClick={() => toggleTab(4)}
                >
            ...
            <div className="flex h-full justify-between w-full">
              <div className="w-[60%] min-h-[83vh] p-5 bg-[#18191A] rounded-md overflow-y-scroll">
                <div className="relative">
                  <input
                    type="text"
                    className="w-[97%] py-1 pl-12 h-[40px] bg-[#3A3B3C] rounded-3xl"
                ...
                <div className="mt-3">
                  <h1 className="text-[#f5f8ff] font-bold text-[20px] font-sans">
                    Social
                  </h1>
                </div>
                ...
                <div>
                  <div className="flex gap-x-1  items-center hover:bg-[#3A3B3C] py-1 rounded-md cursor-pointer">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-[#AEB0B4] p-[2px] ">
                        organize of rind events and other things to do online
                        and nearby
                      </p>
                    </div>
                  </div>
                  <div className="flex  gap-x-1 items-center hover:bg-[#e7e6e650] py-1 rounded-md cursor-pointer">
                    ...
                    <div className="">
                      ...
                      <p className="text-sm text-[#AEB0B4] p-[2px] ">
                        Search fo friends or people you may know.
                      </p>
                    </div>
                  </div>
                ...
                <div className="">
                  <h1 className="text-[#f5fbff] font-semibold">
                    Entertainment
                  </h1>
                  ...
                  <div className="mt-2">
                    ...
                    <div className="flex gap-x-3 pl-2 items-center hover:bg-[#e7e6e650] py-2 rounded-md cursor-pointer">
                      ...
                      <div className="">
                        ...
                        <p className="text-sm text-[#AEB0B4] p-[2px] ">
                          a video destination personalized to you interests and
                          connections
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="mt-2">
                    <h1 className="text-[hsl(210,8%,74%)] font-semibold mb-3">
                      {" "}
                      Shopping
                    </h1>
                    ...
                    <div className="flex gap-x-1  items-center hover:bg-[#e7e6e650] py-1 rounded-md cursor-pointer">
                      ...
                      <div className="">
                        ...
                        <p className="text-sm text-[#AEB0B4] p-[2px] ">
                          A seamless secure way to pay on the apps you already
                          use
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="mt-3">
                    <h1 className="text-[hsl(210,8%,74%)] font-semibold">
                      {" "}
                      Community Resources
                    </h1>
                  </div>
                  ...
                  <div className="mt-2">
                    ...
                    <div className="flex px-2 gap-x-1  items-center hover:bg-[#e7e6e650] py-1 rounded-md cursor-pointer">
                      ...
                      <div className="">
                        ...
                        <p className="text-sm text-[#AEB0B4] p-[2px] ">
                          Find the latest updates for recent crises hapening
                          around the world
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex px-2 gap-x-1  items-center hover:bg-[#e7e6e650] py-1 rounded-md cursor-pointer">
                      ...
                      <div className="">
                        ...
                        <p className="text-sm text-[#AEB0B4] p-[2px] ">
                          Donate and raise money for nonprofits and personal
                          causes
                        </p>
                      </div>
                    </div>
              ...
              <div className="w-[38%] min-h-[75vh] p-3 bg-[#18191A] rounded-md">
                ...
                <div className="mt-3">
                  ...
                  <div className="flex gap-x-3 pl-2 items-center hover:bg-[#e7e6e650] py-2 rounded-md cursor-pointer">
                    <div className="h-[50px] w-[50px] bg-[#faf7f74b] rounded-full flex items-center justify-center">
                      <BsBookHalf size={30} color="#3183DD" />
                    </div>
                    <h2>Story</h2>
                  </div>
                  ...
                  <div className="flex gap-x-3 pl-2 items-center hover:bg-[#e7e6e650] py-2 rounded-md cursor-pointer">
                    <div className="h-[50px] w-[50px] bg-[#faf7f74b] rounded-full flex items-center justify-center">
                      <PiFilmReelDuotone size={30} color="white" />{" "}
                    </div>
                    <h2>Reel</h2>
                  </div>
                  ...
                  <div className="flex gap-x-3 pl-2 items-center hover:bg-[#e7e6e650] py-2 rounded-md cursor-pointer">
                    <div className="h-[50px] w-[50px] bg-[#faf7f74b] rounded-full flex items-center justify-center">
                      <BiSolidVideoPlus size={30} color="#DE58B9" />{" "}
                    </div>
                    <h2>Room</h2>
                  </div>
                  ...
                  <div className="flex gap-x-3 pl-2 items-center hover:bg-[#e7e6e650] py-2 rounded-md cursor-pointer">
                    <div className="h-[50px] w-[50px] bg-[#faf7f74b] rounded-full flex items-center justify-center">
                      <BsFillFlagFill size={30} color="#ED6A40" />
                    </div>
                    <h2>Pages</h2>
                  </div>
                  ...
                  <div className="flex gap-x-3 pl-2 items-center hover:bg-[#e7e6e650] py-2 rounded-md cursor-pointer">
                    <div className="h-[50px] w-[50px] bg-[#faf7f74b] rounded-full flex items-center justify-center">
                      <HiSpeakerphone size={30} color="#338EEE" />{" "}
                    </div>
                    <h2>Ad center</h2>
                  </div>
        ...
        <div className="h-[90vh] w-[25vw] bg-[#242526] fixed right-0 text-white z-10 top-[8%] ">
          <div className="p-3 h-full">
            ...
            <div className="mt-3 flex gap-x-7">
              <h1 className="h-[45px] w-[80px] rounded-3xl flex items-center justify-center text-[20px] bg-[#6e7cff83] cursor-pointer">
                Inbox
              </h1>
              <h1 className="h-[45px] cursor-pointer w-[180px] rounded-3xl flex items-center justify-center text-[20px] bg-[#6e7cff83]">
                Communities
              </h1>
            </div>
              ...
              <div className="flex justify-between items-end">
                <div className="flex gap-x-3  items-center">
                  ...
                  <div className="cursor-pointer">
                    <h1>Md Raja</h1>
                    <p className="text-sm text-[#e7e0e0b6]">
                      {" "}
                      you: sent a photo .1d
                    </p>
                  </div>
      ...
      {grid === 3 && (
        <div className="h-[90vh] w-[25vw] bg-[#242526] fixed right-0 text-white z-10 top-[8%] overflow-y-scroll ">
          <div className="p-3 h-full">
            ...
            <div className="mt-3 flex gap-x-7">
              <h1 className="h-[40px] w-[60px] rounded-3xl flex items-center justify-center  bg-[#6e7cff83] cursor-pointer">
                All
              </h1>
              <h1 className="h-[40px] cursor-pointer w-[100px] rounded-3xl flex items-center justify-center  bg-[#6e7cff83]">
                Unread
              </h1>
            </div>
            ...
            <div className="mt-2 space-y-3">
              <div className="flex justify-between items-end">
                  ...
                  <div className="cursor-pointer w-[75%]">
                    <h1>
                      ...
                      <span className="text-sm">
                        mentioned you and other in a comment in Only argentina
                        And messi Fans
                      </span>{" "}
                    </h1>
                ...
                <div className="h-3 w-6   rounded-full bg-blue-600"></div>
              </div>
              ...
              <div className="mt-2">
                <div className="flex gap-x-2">
                  <img
                    src={"/img/raja.jpg"}
                    alt="img"
                    className="h-[50px] w-[60px] rounded-full object-fill"
                  />
                  ...
                  <div className="w-full">
                    ...
                    >
                      ...
                      <h1 className="text-[#ADB0B5] text-sm">
                        69 mutual friends
                      </h1>
                    </div>

                    <div className="flex gap-x-3 mt-4">
                      <button className="p-2 bg-blue-500  w-[100px] rounded-md">
                        confirm
                      </button>
                      <button className="p-2 bg-[#444546] rounded-md w-[100px]">
                        Delete
                      </button>
                    </div>
                  </div>
          ...
          <div className="p-3 h-full">
            <div className="h-[14vh] w-full bg-[#282a2b] shadow-2xl rounded-md">
              <div className="flex justify-between p-3 items-center hover:bg-[#66666688] rounded-sm">
                <div className="flex items-center gap-x-4">
                  ...
                  />
                  <h1 className="text-[#d6d6d6e7] cursor-pointer text-[20px]">
                    Muhammad badhon
                  </h1>
                </div>
              ...
              <div className="flex justify-between p-3 hover:bg-[#66666688] rounded-md cursor-pointer mt-1">
                ...
                <h1 className="h-[28px] w-[50px]  flex items-center justify-center bg-red-600 rounded-3xl cursor-pointer">
                  69+
                </h1>
              </div>
            </div>
            ...
            <div className=" mt-3 p-1 py-2 rounded-md flex justify-between hover:bg-[#8d898962] cursor-pointer items-center">
              <div className="flex gap-x-2 cursor-pointer items-center">
                <div className="h-[40px] w-[40px] bg-[#bbb3b3a2] rounded-full flex items-center justify-center">
                  <FaMeta size={25} className="" />
                </div>
            ...
            <div className=" mt-1 p-1 py-2 rounded-md flex justify-between hover:bg-[#8d898962] cursor-pointer items-center">
              <div className="flex gap-x-2 cursor-pointer items-center">
                <div className="h-[40px] w-[40px] bg-[#bbb3b3a2] rounded-full flex items-center justify-center">
                  <BiSolidHelpCircle size={25} className="" />
                </div>
            ...
            <div className=" mt-1 p-1 py-2 rounded-md flex justify-between hover:bg-[#8d898962] cursor-pointer items-center">
              <div className="flex gap-x-2 cursor-pointer items-center">
                <div className="h-[40px] w-[40px] bg-[#bbb3b3a2] rounded-full flex items-center justify-center">
                  <RiFeedbackFill size={25} className="" />
                </div>
            ...
            <div className=" mt-1 p-1 py-2 rounded-md flex justify-between hover:bg-[#8d898962] cursor-pointer items-center">
              <div className="flex gap-x-2 cursor-pointer items-center">
                <div className="h-[40px] w-[40px] bg-[#bbb3b3a2] rounded-full flex items-center justify-center">
                  <RiLogoutCircleRLine size={25} className="" />
                </div>
